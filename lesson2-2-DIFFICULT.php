...
<html>
     ...
     <body>
          ...
          <a class="retry-button" href="lesson2-2-DIFFICULT.php">
               <img src="retry.png" />
          </a>
          ...
          <div class="button-container">
               <button class="button" id="properNounBtn"><?= $l22_difficult_statement_1_choice_answer_1 ?></button>
               <button class="button" id="commonNounBtn"><?= $l22_difficult_statement_1_choice_answer_2 ?></button>
          </div>
          ...
          <script>
               ...
               const words = [
                    { word: "<?= $l22_difficult_statement_1 ?>", isProper: <?= $l22_difficult_statement_1_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_1_image ?>" },
                    { word: "<?= $l22_difficult_statement_2 ?>", isProper: <?= $l22_difficult_statement_2_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_2_image ?>" },
                    { word: "<?= $l22_difficult_statement_3 ?>", isProper: <?= $l22_difficult_statement_3_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_3_image ?>" },
                    { word: "<?= $l22_difficult_statement_4 ?>", isProper: <?= $l22_difficult_statement_4_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_4_image ?>" },
                    { word: "<?= $l22_difficult_statement_5 ?>", isProper: <?= $l22_difficult_statement_5_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_5_image ?>" },
                    { word: "<?= $l22_difficult_statement_6 ?>", isProper: <?= $l22_difficult_statement_6_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_6_image ?>" },
                    { word: "<?= $l22_difficult_statement_7 ?>", isProper: <?= $l22_difficult_statement_7_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_7_image ?>" },
                    { word: "<?= $l22_difficult_statement_8 ?>", isProper: <?= $l22_difficult_statement_8_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_8_image ?>" },
                    { word: "<?= $l22_difficult_statement_9 ?>", isProper: <?= $l22_difficult_statement_9_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_9_image ?>" },
                    { word: "<?= $l22_difficult_statement_10 ?>", isProper: <?= $l22_difficult_statement_10_status_for_1 ?>, image: "data:image/png;base64,<?= $l22_difficult_statement_10_image ?>" }
