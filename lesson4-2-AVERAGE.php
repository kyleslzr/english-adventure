...
<div class="animal-container">
  <button class="animal-button" draggable="true" data-animal="myself">MYSELF</button>
  <button class="animal-button" draggable="true" data-animal="yourself">YOURSELF</button>
  <button class="animal-button" draggable="true" data-animal="himself">HIMSELF</button>
  <button class="animal-button" draggable="true" data-animal="herself">HERSELF</button>
  <button class="animal-button" draggable="true" data-animal="itself">ITSELF</button>
  <button class="animal-button" draggable="true" data-animal="ourselves">OURSELVES</button>
  <button class="animal-button" draggable="true" data-animal="yourselves">YOURSELVES</button>
  <button class="animal-button" draggable="true" data-animal="themselves">THEMSELVES</button>
</div>
<div class="droppable-container">
  <div class="droppable" data-animal="herself">
    <img src="herself.jpg" alt="herself">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="himself">
    <img src="himself.jpg" alt="himself">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="yourself">
    <img src="yourself.jpg" alt="yourself">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="myself">
    <img src="myself.jpg" alt="myself">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="themselves">
    <img src="themselves.jpg" alt="themselves">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="yourselves">
    <img src="yourselves.jpg" alt="yourselves">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="ourselves">
    <img src="ourselves.jpg" alt="ourselves">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="itself">
    <img src="itself.jpg" alt="itself">
    <div class="animal-word"></div>
  </div>
</div>
<script>
