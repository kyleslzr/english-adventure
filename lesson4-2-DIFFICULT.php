...
<div class="animal-container">
  <button class="animal-button" draggable="true" data-animal="this">THIS</button>
  <button class="animal-button" draggable="true" data-animal="that">THAT</button>
  <button class="animal-button" draggable="true" data-animal="these">THESE</button>
  <button class="animal-button" draggable="true" data-animal="those">THOSE</button>
  <button class="animal-button" draggable="true" data-animal="who">WHO</button>
  <button class="animal-button" draggable="true" data-animal="whom">WHOM</button>
  <button class="animal-button" draggable="true" data-animal="whose">WHOSE</button>
  <button class="animal-button" draggable="true" data-animal="which">WHICH</button>
</div>
<div class="droppable-container">
  <div class="droppable" data-animal="those">
    <img src="those.jpg" alt="those">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="these">
    <img src="these.jpg" alt="these">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="that">
    <img src="that.jpg" alt="that">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="this">
    <img src="this.jpg" alt="this">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="which">
    <img src="which.jpg" alt="which">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="whose">
    <img src="whose.jpg" alt="whose">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="whom">
    <img src="whom.jpg" alt="whom">
    <div class="animal-word"></div>
  </div>
  <div class="droppable" data-animal="who">
    <img src="who.jpg" alt="who">
    <div class="animal-word"></div>
  </div>
</div>
<script>
