...
<html lang="en">
     ...
     <body>
          ...
          <script>
               const initialImages = ['data:image/png;base64,<?= $l51_average_word_1_image ?>', 'data:image/png;base64,<?= $l51_average_word_1_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_1_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_1_image_3 ?>'];
               const duckImages = ['data:image/png;base64,<?= $l51_average_word_2_image ?>', 'data:image/png;base64,<?= $l51_average_word_2_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_2_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_2_image_3 ?>'];
               const padImages = ['data:image/png;base64,<?= $l51_average_word_3_image ?>', 'data:image/png;base64,<?= $l51_average_word_3_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_3_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_3_image_3 ?>'];
               const dotImages = ['data:image/png;base64,<?= $l51_average_word_4_image ?>', 'data:image/png;base64,<?= $l51_average_word_4_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_4_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_4_image_3 ?>'];
               const budImages = ['data:image/png;base64,<?= $l51_average_word_5_image ?>', 'data:image/png;base64,<?= $l51_average_word_5_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_5_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_5_image_3 ?>'];
               const potImages = ['data:image/png;base64,<?= $l51_average_word_6_image ?>', 'data:image/png;base64,<?= $l51_average_word_6_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_6_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_6_image_3 ?>'];
               const ratImages = ['data:image/png;base64,<?= $l51_average_word_7_image ?>', 'data:image/png;base64,<?= $l51_average_word_7_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_7_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_7_image_3 ?>'];
               const kitImages = ['data:image/png;base64,<?= $l51_average_word_8_image ?>', 'data:image/png;base64,<?= $l51_average_word_8_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_8_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_8_image_3 ?>'];
               const tenImages = ['data:image/png;base64,<?= $l51_average_word_9_image ?>', 'data:image/png;base64,<?= $l51_average_word_9_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_9_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_9_image_3 ?>'];
               const topImages = ['data:image/png;base64,<?= $l51_average_word_10_image ?>', 'data:image/png;base64,<?= $l51_average_word_10_image_2 ?>', 'data:image/png;base64,<?= $l51_average_word_10_image_3 ?>', 'data:image/png;base64,<?= $l51_average_word_10_image_3 ?>'];
               let currentAnswer = '';
