...
<audio autoplay loop controlsList="nodownload" style="display: none">
  ...
  Your browser does not support the audio element.
    ...
    <a class="retry-button" href="lesson4-1-DIFFICULT.php">
        <img src="retry.png" />
    </a>
...
<script>
  const initialImages = ['data:image/png;base64,<?= $l41_difficult_word_1_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_1_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_1_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_1_image_3 ?>'];
  const duckImages = ['data:image/png;base64,<?= $l41_difficult_word_2_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_2_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_2_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_2_image_3 ?>'];
  const padImages = ['data:image/png;base64,<?= $l41_difficult_word_3_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_3_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_3_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_3_image_3 ?>'];
  const dotImages = ['data:image/png;base64,<?= $l41_difficult_word_4_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_4_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_4_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_4_image_3 ?>'];
  const budImages = ['data:image/png;base64,<?= $l41_difficult_word_5_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_5_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_5_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_5_image_3 ?>'];
  const potImages = ['data:image/png;base64,<?= $l41_difficult_word_6_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_6_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_6_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_6_image_3 ?>'];
  const ratImages = ['data:image/png;base64,<?= $l41_difficult_word_7_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_7_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_7_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_7_image_3 ?>'];
  const kitImages = ['data:image/png;base64,<?= $l41_difficult_word_8_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_8_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_8_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_8_image_3 ?>'];
  const tenImages = ['data:image/png;base64,<?= $l41_difficult_word_9_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_9_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_9_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_9_image_3 ?>'];
  const topImages = ['data:image/png;base64,<?= $l41_difficult_word_10_image ?>', 'data:image/png;base64,<?= $l41_difficult_word_10_image_2 ?>', 'data:image/png;base64,<?= $l41_difficult_word_10_image_3 ?>', 'data:image/png;base64,<?= $l41_difficult_word_10_image_3 ?>'];
  let currentAnswer = '';
  let correctAnswer = '<?= $l41_difficult_word_1_correct_word ?>'; // Set the initial correct answer
...
function checkAnswer() {
    ...
    if (currentAnswer.toLowerCase() === correctAnswer) {
        ...
        setTimeout(() => {
            if (correctAnswer === '<?= $l41_difficult_word_1_correct_word ?>') {
                loadDuckGame();
                correctAnswer = '<?= $l41_difficult_word_2_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_2_correct_word ?>') {
                loadPadGame();
                correctAnswer = '<?= $l41_difficult_word_3_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_3_correct_word ?>') {
                loadDotGame();
                correctAnswer = '<?= $l41_difficult_word_4_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_4_correct_word ?>') {
                loadBudGame();
                correctAnswer = '<?= $l41_difficult_word_5_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_5_correct_word ?>') {
                loadPotGame();
                correctAnswer = '<?= $l41_difficult_word_6_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_6_correct_word ?>') {
                loadRatGame();
                correctAnswer = '<?= $l41_difficult_word_7_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_7_correct_word ?>') {
                loadKitGame();
                correctAnswer = '<?= $l41_difficult_word_8_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_8_correct_word ?>') {
                loadTenGame(); 
                correctAnswer = '<?= $l41_difficult_word_9_correct_word ?>';
            } else if (correctAnswer === '<?= $l41_difficult_word_9_correct_word ?>') {
                loadTopGame();
                correctAnswer = '<?= $l41_difficult_word_10_correct_word ?>';
            }
