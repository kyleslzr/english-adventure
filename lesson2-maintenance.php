<?php 
     ...
     $returnToThisPage = "../lesson2-maintenance.php";   
?>
<?php
     ...
     // Retrieval of data
     $retrieveQuery = "SELECT * FROM lesson_titles WHERE user_ID = ? AND lesson_activity_number IN (21, 22)";
...
<?php
     ...
     // Retrieval of data
     $retrieveQuery = "SELECT * FROM lesson_tutorial_url WHERE user_ID = ? AND lesson_activity_number IN (21, 22)";
     $retrieveStmt = mysqli_prepare($conn, $retrieveQuery);
     mysqli_stmt_bind_param($retrieveStmt, "i", $user_ID);
     mysqli_stmt_execute($retrieveStmt);
...
<?php
     ...
     $retrieveQuery = "SELECT * FROM word_sound_activity_2 WHERE user_ID = ?";
     $retrieveStmt = mysqli_prepare($conn, $retrieveQuery);
     mysqli_stmt_bind_param($retrieveStmt, "i", $user_ID);
     mysqli_stmt_execute($retrieveStmt);
     ...
     while ($row = mysqli_fetch_assoc($result)) {
     for ($i = 1; $i <= 8; $i++) {
          $inputNameImage = "l21_easy_word_" . $count . "_image";
          $statusName = "l21_easy_word_" . $count . "_correct_word";
     ...
     while ($row = mysqli_fetch_assoc($result)) {
     for ($i = 1; $i <= 8; $i++) {
          $inputNameImage = "l21_average_word_" . $count . "_image";
          $statusName = "l21_average_word_" . $count . "_correct_word";
     ...
     while ($row = mysqli_fetch_assoc($result)) {
     for ($i = 1; $i <= 8; $i++) {
          $inputNameImage = "l21_difficult_word_" . $count . "_image";
          $statusName = "l21_difficult_word_" . $count . "_correct_word";
...
<?php
     ...
     // Retrieve data for l11_easy
     $retrieveQuery = "SELECT * FROM recognizing_word_activity WHERE user_ID = ?";
     $retrieveStmt = mysqli_prepare($conn, $retrieveQuery);
     mysqli_stmt_bind_param($retrieveStmt, "i", $user_ID);
     mysqli_stmt_execute($retrieveStmt);
     ...
     while ($row = mysqli_fetch_assoc($result)) {
     for ($i = 1; $i <= 10; $i++) {
          $inputName = "l22_easy_statement_$i";
     ...
     while ($row = mysqli_fetch_assoc($result)) {
     for ($i = 1; $i <= 10; $i++) {
          $inputName = "l22_average_statement_$i";
          $inputNameImage = $inputName . "_image";
          $correctAnswer1 = $inputName . "_choice_answer_1";
          $correctAnswer2 = $inputName . "_choice_answer_2";
          $theCorrectAnswer = $inputName . "_status";
     ...
     while ($row = mysqli_fetch_assoc($result)) {
     for ($i = 1; $i <= 10; $i++) {
          $inputName = "l22_difficult_statement_$i";
          $inputNameImage = $inputName . "_image";
          $correctAnswer1 = $inputName . "_choice_answer_1";
          $correctAnswer2 = $inputName . "_choice_answer_2";
          $theCorrectAnswer = $inputName . "_status";
...
<html lang="en">
     <head>
          ...
          <title>Lesson 2 - Maintenance</title>
          <style>
               body {
                    overflow: hidden;
                    margin: 0;
     ...
     <body class="position-relative">
          ...
          <div class="container-xxl">
               <div>
                    <div class="d-flex justify-content-center">
                         <div class="lesson-title text-center">Lesson 2- Maintenance</div>
                    </div>
               </div>
               <div class="d-flex justify-content-center">
                    ...
                    <div class="modal-content">
                         <form action="function/save-lesson-title.php" method="post">
                              <div class="modal-header d-block">
                                   <h5 class="modal-title" id="tutorialVideoModalLabel">Lesson 2 Activity 1 Title and Directions</h5>
                              </div>
                              <div class="modal-body">
                                   <div>
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 2 Activity 1 title has been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <input type="hidden" name="lesson_activity_number" value="21">
                                             <div class="w-100">
          ...
          <div class="modal fade" id="lesson-title-act2" tabindex="-1" role="dialog" aria-hidden="true">
               <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                         <form action="function/save-lesson-title.php" method="post">
                              <div class="modal-header d-block">
                                   <h5 class="modal-title" id="tutorialVideoModalLabel">Lesson 2 Activity 2 Title and Directions</h5>
                              </div>
                              <div class="modal-body">
                                   <div>
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 2 Activity 2 title has been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <input type="hidden" name="lesson_activity_number" value="22">
                                             <div class="w-100">
          ...
          <!-- act 1 form -->
               ...
               <div class="modal fade" id="<?= $difficulty ?>-act1" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                         <div class="modal-content">
                              <form action="function/save-word-sound-2.php" enctype="multipart/form-data" method="post">
                                   <div class="modal-header d-block">
                                   ...
                                   <div>
                                        <div class="input-group mb-3">
                                             ...
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 2 Activity 1 <?= $difficulty ?> round items have been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <div>
                                                  <div>
                                                       <?php
                                                       ...
                                                       <div class="mt-4">
                                                            <div class="d-flex">
                                                                 ...
                                                                 <div style="width: 89%;">
                                                                      ...
                                                                      <input name="' . $inputNameImage . '" class="fs-5 rounded ms-2 form-control mb-3" type="file" id="formFile" accept=".jpg, .jpeg, .png">
          ...
          <?php
               ...
               <div class="modal fade" id="<?= $difficulty ?>-act2" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                         <div class="modal-content">
                              <form action="function/save-recognizing-activity.php" enctype="multipart/form-data" method="post">
                                   <div class="modal-header d-block">
                                   ...
                                   <div>
                                        ...
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="round" value="<?= $lesson ?>_<?= $difficulty ?>">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 2 Activity 2 <?= $difficulty ?> round items have been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <div style="width: 100%;">
                                                  <div>
                                                       <?php
                                                       ...
                                                       $inputStatus = isset(${"l22_{$difficulty}_statement_{$i}_status"}) ? ${"l22_{$difficulty}_statement_{$i}_status"} : '';               
                                                            ...
                                                            <div class="d-flex">
                                                                 ...
                                                                 <div style="width: 89%;">
                                                                      ...
                                                                      <div class="d-flex align-items-center mb-3">
                                                                           ...
                                                                           <input type="text" name="' . $inputName . '_choice_answer_1" class="fs-5 rounded ms-2 form-control l22-' . $difficulty . '-option-1" placeholder="Enter 1st choice" aria-describedby="basic-addon1" value="' . $correctAnswer1 . '" required>
                                                                      </div>
                                                                      <div class="d-flex align-items-center">
                                                                           <input class="form-check-input" type="radio" name="' . $inputName . '_status" id="inlineRadio2_' . $i . '" value="2" ' . ($inputStatus === 2 ? 'checked' : '') . '>
                                                                           <input type="text" name="' . $inputName . '_choice_answer_2" class="fs-5 rounded ms-2 form-control l22-' . $difficulty . '-option-2" placeholder="Enter 2nd choice" aria-describedby="basic-addon1" value="' . $correctAnswer2 . '" required>
                                                                      </div>
                                                                 </div>
                                                            </div>
                                                       </div>';
          ...
          addInputListeners('l22-easy-option-1');
          addInputListeners('l22-average-option-1');
          addInputListeners('l22-difficult-option-1');
          addInputListeners('l22-easy-option-2');
          addInputListeners('l22-average-option-2');
          addInputListeners('l22-difficult-option-2');
          </script>
     </body>
</html>