...
<script>
  const initialImages = ['data:image/png;base64,<?= $l41_easy_word_1_image ?>', 'data:image/png;base64,<?= $l41_easy_word_1_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_1_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_1_image_4 ?>'];
  const duckImages = ['data:image/png;base64,<?= $l41_easy_word_2_image ?>', 'data:image/png;base64,<?= $l41_easy_word_2_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_2_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_2_image_4 ?>'];
  const padImages = ['data:image/png;base64,<?= $l41_easy_word_3_image ?>', 'data:image/png;base64,<?= $l41_easy_word_3_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_3_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_3_image_4 ?>'];
  const dotImages = ['data:image/png;base64,<?= $l41_easy_word_4_image ?>', 'data:image/png;base64,<?= $l41_easy_word_4_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_4_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_4_image_4 ?>'];
  const budImages = ['data:image/png;base64,<?= $l41_easy_word_5_image ?>', 'data:image/png;base64,<?= $l41_easy_word_5_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_5_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_5_image_4 ?>'];
  const potImages = ['data:image/png;base64,<?= $l41_easy_word_6_image ?>', 'data:image/png;base64,<?= $l41_easy_word_6_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_6_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_6_image_4 ?>'];
  const ratImages = ['data:image/png;base64,<?= $l41_easy_word_7_image ?>', 'data:image/png;base64,<?= $l41_easy_word_7_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_7_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_7_image_4 ?>'];
  const kitImages = ['data:image/png;base64,<?= $l41_easy_word_8_image ?>', 'data:image/png;base64,<?= $l41_easy_word_8_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_8_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_8_image_4 ?>'];
  const tenImages = ['data:image/png;base64,<?= $l41_easy_word_9_image ?>', 'data:image/png;base64,<?= $l41_easy_word_9_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_9_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_9_image_4 ?>'];
  const topImages = ['data:image/png;base64,<?= $l41_easy_word_10_image ?>', 'data:image/png;base64,<?= $l41_easy_word_10_image_2 ?>', 'data:image/png;base64,<?= $l41_easy_word_10_image_3 ?>', 'data:image/png;base64,<?= $l41_easy_word_10_image_4 ?>'];
  let currentAnswer = '';
