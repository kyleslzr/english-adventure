...
height: 240px;
  ...
  <button id="erase-button" onclick="eraseLetters()"><svg xmlns="http://www.w3.org/2000/svg" height="32" width="36" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M576 128c0-35.3-28.7-64-64-64H205.3c-17 0-33.3 6.7-45.3 18.7L9.4 233.4c-6 6-9.4 14.1-9.4 22.6s3.4 16.6 9.4 22.6L160 429.3c12 12 28.3 18.7 45.3 18.7H512c35.3 0 64-28.7 64-64V128zM271 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z"/></svg></button>
          ...
          <script>
               const initialImages = ['data:image/png;base64,<?= $l51_easy_word_1_image ?>', 'data:image/png;base64,<?= $l51_easy_word_1_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_1_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_1_image_4 ?>'];
               const duckImages = ['data:image/png;base64,<?= $l51_easy_word_2_image ?>', 'data:image/png;base64,<?= $l51_easy_word_2_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_2_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_2_image_4 ?>'];
               const padImages = ['data:image/png;base64,<?= $l51_easy_word_3_image ?>', 'data:image/png;base64,<?= $l51_easy_word_3_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_3_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_3_image_4 ?>'];
               const dotImages = ['data:image/png;base64,<?= $l51_easy_word_4_image ?>', 'data:image/png;base64,<?= $l51_easy_word_4_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_4_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_4_image_4 ?>'];
               const budImages = ['data:image/png;base64,<?= $l51_easy_word_5_image ?>', 'data:image/png;base64,<?= $l51_easy_word_5_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_5_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_5_image_4 ?>'];
               const potImages = ['data:image/png;base64,<?= $l51_easy_word_6_image ?>', 'data:image/png;base64,<?= $l51_easy_word_6_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_6_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_6_image_4 ?>'];
               const ratImages = ['data:image/png;base64,<?= $l51_easy_word_7_image ?>', 'data:image/png;base64,<?= $l51_easy_word_7_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_7_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_7_image_4 ?>'];
               const kitImages = ['data:image/png;base64,<?= $l51_easy_word_8_image ?>', 'data:image/png;base64,<?= $l51_easy_word_8_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_8_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_8_image_4 ?>'];
               const tenImages = ['data:image/png;base64,<?= $l51_easy_word_9_image ?>', 'data:image/png;base64,<?= $l51_easy_word_9_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_9_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_9_image_4 ?>'];
               const topImages = ['data:image/png;base64,<?= $l51_easy_word_10_image ?>', 'data:image/png;base64,<?= $l51_easy_word_10_image_2 ?>', 'data:image/png;base64,<?= $l51_easy_word_10_image_3 ?>', 'data:image/png;base64,<?= $l51_easy_word_10_image_4 ?>'];
               let currentAnswer = '';
               let correctAnswer = '<?= $l51_easy_word_1_correct_word ?>'; // Set the initial correct answer
               ...
               function checkAnswer() {
                    ...
                    if (currentAnswer.toLowerCase() === correctAnswer) {
                         ...
                         setTimeout(() => {
                              if (correctAnswer === '<?= $l51_easy_word_1_correct_word ?>') {
                                   loadDuckGame();
                                   correctAnswer = '<?= $l51_easy_word_2_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_2_correct_word ?>') {
                                   loadPadGame();
                                   correctAnswer = '<?= $l51_easy_word_3_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_3_correct_word ?>') {
                                   loadDotGame();
                                   correctAnswer = '<?= $l51_easy_word_4_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_4_correct_word ?>') {
                                   loadBudGame();
                                   correctAnswer = '<?= $l51_easy_word_5_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_5_correct_word ?>') {
                                   loadPotGame();
                                   correctAnswer = '<?= $l51_easy_word_6_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_6_correct_word ?>') {
                                   loadRatGame();
                                   correctAnswer = '<?= $l51_easy_word_7_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_7_correct_word ?>') {
                                   loadKitGame();
                                   correctAnswer = '<?= $l51_easy_word_8_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_8_correct_word ?>') {
                                   loadTenGame();
                                   correctAnswer = '<?= $l51_easy_word_9_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_easy_word_9_correct_word ?>') {
                                   loadTopGame();
                                   correctAnswer = '<?= $l51_easy_word_10_correct_word ?>';
                              }
