<?php 
     ...
     $returnToThisPage = "../lesson3-maintenance.php";   
?>
<?php
     ...
     // Retrieval of data
     $retrieveQuery = "SELECT * FROM lesson_titles WHERE user_ID = ? AND lesson_activity_number IN (31, 32)";
...
<?php
     ...
     // Retrieval of data
     $retrieveQuery = "SELECT * FROM lesson_tutorial_url WHERE user_ID = ? AND lesson_activity_number IN (31, 32)";
     $retrieveStmt = mysqli_prepare($conn, $retrieveQuery);
     mysqli_stmt_bind_param($retrieveStmt, "i", $user_ID);
     mysqli_stmt_execute($retrieveStmt);
...
<html lang="en">
     <head>
          ...
          <title>Lesson 3 - Maintenance</title>
          <style>
               body {
                    overflow: hidden;
                    margin: 0;
     ...
     <body class="position-relative">
          ...
          <div class="container-xxl">
               <div>
                    <div class="d-flex justify-content-center">
                         <div class="lesson-title text-center">Lesson 3- Maintenance</div>
                    </div>
               </div>
               <div class="d-flex justify-content-center">
                    ...
                    <div class="modal-content">
                         <form action="function/save-lesson-title.php" method="post">
                              <div class="modal-header d-block">
                                   <h5 class="modal-title" id="tutorialVideoModalLabel">Lesson 3 Activity 1 Title and Directions</h5>
                              </div>
                              <div class="modal-body">
                                   <div>
                                        <div class="input-group mb-3">
                                             ...
                                             <input type="hidden" name="lesson_activity_number" value="31">
                                             <div class="w-100">
          ...
          <div class="modal fade" id="lesson-title-act2" tabindex="-1" role="dialog" aria-hidden="true">
               <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                         <form action="function/save-lesson-title.php" method="post">
                              <div class="modal-header d-block">
                                   <h5 class="modal-title" id="tutorialVideoModalLabel">Lesson 3 Activity 2 Title and Directions</h5>
                              </div>
                              <div class="modal-body">
                                   <div>
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 3 Activity 2 title has been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <input type="hidden" name="lesson_activity_number" value="32">
                                             <div class="w-100">
                         ...
                         <form action="function/save-lesson-tutorial-url.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="modal-body">
                                        <div>
                                             <div class="input-group mb-3">
                                                  <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                                  <input type="hidden" name="alert" value="Lesson 3 Activity 1 tutorial has been successfully updated.">
                                                  <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                                  <input type="hidden" name="lesson_activity_number" value="31">
                         ...
                         <form action="function/save-lesson-tutorial-url.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="modal-body">
                                        <div>
                                             <div class="input-group mb-3">
                                                  <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                                  <input type="hidden" name="alert" value="Lesson 3 Activity 2 tutorial has been successfully updated.">
                                                  <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                                  <input type="hidden" name="lesson_activity_number" value="32">
          ...
          <!-- act 1 form -->
               ...
               <div class="modal fade" id="<?= $difficulty ?>-act1" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                         <div class="modal-content">
                              <form action="function/save-word-sound-3.php" enctype="multipart/form-data" method="post">
                                   <div class="modal-header d-block">
                                   ...
                                   <div>
                                        <div class="input-group mb-3">
                                             ...
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 3 Activity 1 <?= $difficulty ?> round items have been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <div>
                                                  <div>
                                                       <?php
          ...
          <?php
               ...
               <div class="modal fade" id="<?= $difficulty ?>-act2" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                         <div class="modal-content">
                              <form action="function/save-recognizing-activity-2.php" enctype="multipart/form-data" method="post">
                                   <div class="modal-header d-block">
                                   ...
                                   <div>
                                        ...
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="round" value="<?= $lesson ?>_<?= $difficulty ?>">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 3 Activity 2 <?= $difficulty ?> round items have been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <div style="width: 100%;">
                                                  <div>
                                                       <?php
                                                       ...
                                                       $inputStatus = isset(${"l32_{$difficulty}_statement_{$i}_status"}) ? ${"l32_{$difficulty}_statement_{$i}_status"} : '';               
