...
<html lang="en">
     ...
     <body>
          ...
          <div class="animal-container" id="random">
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_1_correct_word_l42 ?>"><?= $l41_easy_word_1_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_2_correct_word_l42 ?>"><?= $l41_easy_word_2_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_3_correct_word_l42 ?>"><?= $l41_easy_word_3_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_4_correct_word_l42 ?>"><?= $l41_easy_word_4_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_5_correct_word_l42 ?>"><?= $l41_easy_word_5_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_6_correct_word_l42 ?>"><?= $l41_easy_word_6_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_7_correct_word_l42 ?>"><?= $l41_easy_word_7_correct_word_l42 ?></button>
               <button class="animal-button" draggable="true" data-animal="<?= $l41_easy_word_8_correct_word_l42 ?>"><?= $l41_easy_word_8_correct_word_l42 ?></button>
          </div>
          <div class="droppable-container" id="random-1">
               <div class="droppable" data-animal="<?= $l41_easy_word_1_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_1_image_l42 ?>" alt="<?= $l41_easy_word_1_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_2_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_2_image_l42 ?>" alt="<?= $l41_easy_word_2_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_3_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_3_image_l42 ?>" alt="<?= $l41_easy_word_3_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_4_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_4_image_l42 ?>" alt="<?= $l41_easy_word_4_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_5_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_5_image_l42 ?>" alt="<?= $l41_easy_word_5_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_6_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_6_image_l42 ?>" alt="<?= $l41_easy_word_6_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_7_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_7_image_l42 ?>" alt="<?= $l41_easy_word_7_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
               <div class="droppable" data-animal="<?= $l41_easy_word_8_correct_word_l42 ?>">
                    <img src="data:image/png;base64,<?= $l41_easy_word_8_image_l42 ?>" alt="<?= $l41_easy_word_8_correct_word_l42 ?>">
                    <div class="animal-word"></div>
               </div>
