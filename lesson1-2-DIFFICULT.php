...
<head>
    ...
    <link rel="stylesheet" href="css/side-score-style.css">
     ...
     <body>
          ...
          <a class="retry-button" href="lesson1-2-DIFFICULT.php">
               <img src="retry.png" />
          </a>
          ...
          <script>
               ...
               const questions = [
                    "Dad drives us safely in the car , enjoying the scenic route through the mountains , as we listen to our favorite songs and share stories along the way",
                    "These flowers are beautiful , blooming in a myriad of colors under the warm sunlight , attracting butterflies that dance around them, adding enchantment to the garden",
                    "Sam plays with his friend Ben , sharing laughter and joy on the playground , their friendship growing stronger with every shared adventure and playful escapade",
                    "The bus stops at the red light , patiently waiting for the signal to continue its journey , while passengers exchange friendly smiles and engage in casual conversations",
                    "We saw tigers at the zoo , marveling at their majestic presence and powerful demeanor , grateful for the opportunity to witness these magnificent creatures up close and learn about their conservation",
                    "The boy kicked the ball, sending it soaring through the air with swift precision, and his friends cheered in excitement , creating a moment of shared triumph on the field",
                    "The cat is purring , contentedly nestled on the windowsill as the rain gently taps against the glass , creating a cozy atmosphere that invites reflection and relaxation",
                    "I flew a kite in the fields , feeling the exhilarating pull against the wind in the open expanse , losing myself in the simple joy of watching colors dance in the sky"
               ];
               ...
               const correctNouns = [
                    ["Dad", "us", "car", "route", "mountains", "songs", "stories"],
                    ["These", "flowers", "colors", "sunlight", "butterflies", "garden"],
                    ["Sam", "friend", "Ben", "laughter", "joy", "playground", "friendship", "adventure", "escapade"],
                    ["The", "bus", "light", "signal", "journey", "passengers", "smiles", "conversations"],
                    ["We", "tigers", "zoo", "presence", "demeanor", "opportunity", "creatures", "conservation"],
                    ["The", "boy", "ball", "air", "precision", "friends", "excitement", "moment", "triumph", "field"],
                    ["The", "cat", "windowsill", "rain", "glass", "atmosphere", "reflection", "relaxation"],
                    ["I", "kite", "fields", "pull", "wind", "open expanse", "colors", "sky"]
               ];
               ...
               const maxNouns = [7, 6, 9, 8, 8, 10, 8, 8];
