<?php 
     ...
     $returnToThisPage = "../lesson4-maintenance.php";   
?>
<?php
     ...
     // Retrieval of data
     $retrieveQuery = "SELECT * FROM lesson_titles WHERE user_ID = ? AND lesson_activity_number IN (41, 42)";
...
<?php
     ...
     // Retrieval of data
     $retrieveQuery = "SELECT * FROM lesson_tutorial_url WHERE user_ID = ? AND lesson_activity_number IN (41, 42)";
     $retrieveStmt = mysqli_prepare($conn, $retrieveQuery);
     mysqli_stmt_bind_param($retrieveStmt, "i", $user_ID);
     mysqli_stmt_execute($retrieveStmt);
...
<?php
     ...
     for ($i = 1; $i <= 10; $i++) {
          ...
          $inputNameImage3 = "l41_difficult_" . $count . "_image_3";
...
<html lang="en">
     <head>
          ...
          <title>Lesson 4 - Maintenance</title>
          <style>
               body {
                    overflow: hidden;
                    margin: 0;
     ...
     <body class="position-relative">
          ...
          <div class="container-xxl">
               <div>
                    <div class="d-flex justify-content-center">
                         <div class="lesson-title text-center">Lesson 4- Maintenance</div>
                    </div>
               </div>
               <div class="d-flex justify-content-center">
                    ...
                    <div class="modal-content">
                         <form action="function/save-lesson-title.php" method="post">
                              <div class="modal-header d-block">
                                   <h5 class="modal-title" id="tutorialVideoModalLabel">Lesson 4 Activity 1 Title and Directions</h5>
                              </div>
                              <div class="modal-body">
                                   <div>
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 3 Activity 1 title has been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <input type="hidden" name="lesson_activity_number" value="41">
                                             <div class="w-100">
          ...
          <div class="modal fade" id="lesson-title-act2" tabindex="-1" role="dialog" aria-hidden="true">
               <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                         <form action="function/save-lesson-title.php" method="post">
                              <div class="modal-header d-block">
                                   <h5 class="modal-title" id="tutorialVideoModalLabel">Lesson 4 Activity 2 Title and Directions</h5>
                              </div>
                              <div class="modal-body">
                                   <div>
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 4 Activity 2 title has been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <input type="hidden" name="lesson_activity_number" value="42">
                                             <div class="w-100">
                         ...
                         <form action="function/save-lesson-tutorial-url.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="modal-body">
                                        <div>
                                             <div class="input-group mb-3">
                                                  <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                                  <input type="hidden" name="alert" value="Lesson 4 Activity 1 tutorial has been successfully updated.">
                                                  <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                                  <input type="hidden" name="lesson_activity_number" value="41">
                         ...
                         <form action="function/save-lesson-tutorial-url.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="modal-body">
                                        <div>
                                             <div class="input-group mb-3">
                                                  <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                                  <input type="hidden" name="alert" value="Lesson 4 Activity 2 tutorial has been successfully updated.">
                                                  <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                                  <input type="hidden" name="lesson_activity_number" value="42">
          ...
          <!-- act 1 form -->
               ...
               <div class="modal fade" id="<?= $difficulty ?>-act1" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                         <div class="modal-content">
                              <form action="function/save-word-sound-4.php" enctype="multipart/form-data" method="post">
                                   <div class="modal-header d-block">
                                   ...
                                   <div>
                                        <div class="input-group mb-3">
                                             ...
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 4 Activity 1 <?= $difficulty ?> round items have been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <div style="width: 100%;">
                                                  <div>
                                                       <?php
          ...
          <?php
               ...
               <div class="modal fade" id="<?= $difficulty ?>-act2" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                         <div class="modal-content">
                              <form action="function/save-using-word-activity.php" enctype="multipart/form-data" method="post">
                                   <div class="modal-header d-block">
                                   ...
                                   <div>
                                        <div class="input-group mb-3">
                                             <input type="hidden" name="round" value="<?= $lesson ?>_<?= $difficulty ?>">
                                             <input type="hidden" name="return" value="<?= $returnToThisPage ?>">
                                             <input type="hidden" name="alert" value="Lesson 4 Activity 2 <?= $difficulty ?> round items have been successfully updated.">
                                             <input type="hidden" name="user_ID" value="<?= $user_ID ?>">
                                             <div>
                                                  <div>
                                                       <?php
                                                       ...
                                                       $inputName = "{$lesson}_{$difficulty}_word_$i";
                                                       // l21_easy_word_1_image
                                                       $correctAnswer = isset(${"{$lesson}_{$difficulty}_word_{$i}_correct_word_l42"}) ? ${"{$lesson}_{$difficulty}_word_{$i}_correct_word_l42"} : '';
                                                       // l21_easy_word_1_correct_word
                                                       $inputNameImage = "{$lesson}_{$difficulty}_word_{$i}_image";      
                                                       $inputNameImageValue = isset(${"{$lesson}_{$difficulty}_word_{$i}_image_l42"}) ? ${"{$lesson}_{$difficulty}_word_{$i}_image_l42"} : '';   
                                                       $inputNameImageShow = empty(${"{$lesson}_{$difficulty}_word_{$i}_image_l42"}) ? 'd-none' : 'd-block mb-4';              
