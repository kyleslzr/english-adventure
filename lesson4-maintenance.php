...
"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#00741e}</style><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/>
  ...
  <div class="lesson-bar">
    ...
    <div class="lesson-labels recognizing-sounds">
      ...
      <a href="#" class="tutor-button" id="upload-tutorial-video-l41">
        <div style="
           display: flex;
           align-items: center;
      ...
      <a href="#" class="play-button" id="upload-EASY-l41">
        <div style="
           display: flex;
           align-items: center;
      ...
      <a href="#" class="play-button" id="upload-AVERAGE-l41">
        <div style="
           display: flex;
           align-items: center;
      ...
      <a href="#" class="play-button" id="upload-DIFFICULT-l41">
        <div style="
           display: flex;
           align-items: center;
...
">
      ...
      <div class="lesson-btn">
      <a href="#" class="tutor-button" id="upload-tutorial-video-l42">
        <div style="
           display: flex;
           align-items: center;
      ...
      <a href="#" class="play-button" id="upload-EASY-l42">
        <div style="
           display: flex;
           align-items: center;
      ...
      <a href="#" class="play-button" id="upload-AVERAGE-l42">
        <div style="
           display: flex;
           align-items: center;
      ...
      <a href="#" class="play-button" id="upload-EDIFFICULT-l42">
        <div style="
           display: flex;
           align-items: center;
