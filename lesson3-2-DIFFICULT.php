...
<img class="vine animate__bounce" src="vine1.png" alt="Traveler 5 Image" />
          ...
          <script>
               ...
               const words = [
                    { word: "Ocean", isProper: false, image: "ocean.jpg" },
                    { word: "Adventure", isProper: false, image: "adventure.jpg" },
                    { word: "NewYork", isProper: true, image: "nyc.jpg" },
                    { word: "Einstein", isProper: true, image: "albert.jpg" },
                    { word: "EiffelTower", isProper: true, image: "tet.jpg" },
                    { word: "Robot", isProper: false, image: "robot.jpg" },
                    { word: "MonaLisa", isProper: true, image: "mona.jpg" },
                    { word: "GreatWallofChina", isProper: true, image: "tgwc.jpg" },
                    { word: "Restaurant", isProper: false, image: "resto.jpg" },
                    { word: "Garden", isProper: false, image: "garden.jpg" }
               ];
