...
<html lang="en">
     ...
     <body>
          ...
          <div class="lesson-title" style="top: 52px;"><?= $lesson1 ?><?= $l51_difficult_word_10_correct_word ?></div>
          ...
          <script>
               const initialImages = ['data:image/png;base64,<?= $l51_difficult_word_1_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_1_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_1_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_1_image_4 ?>'];
               const duckImages = ['data:image/png;base64,<?= $l51_difficult_word_2_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_2_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_2_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_2_image_4 ?>'];
               const padImages = ['data:image/png;base64,<?= $l51_difficult_word_3_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_3_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_3_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_3_image_4 ?>'];
               const dotImages = ['data:image/png;base64,<?= $l51_difficult_word_4_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_4_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_4_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_4_image_4 ?>'];
               const budImages = ['data:image/png;base64,<?= $l51_difficult_word_5_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_5_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_5_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_5_image_4 ?>'];
               const potImages = ['data:image/png;base64,<?= $l51_difficult_word_6_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_6_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_6_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_6_image_4 ?>'];
               const ratImages = ['data:image/png;base64,<?= $l51_difficult_word_7_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_7_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_7_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_7_image_4 ?>'];
               const kitImages = ['data:image/png;base64,<?= $l51_difficult_word_8_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_8_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_8_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_8_image_4 ?>'];
               const tenImages = ['data:image/png;base64,<?= $l51_difficult_word_9_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_9_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_9_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_9_image_4 ?>'];
               const topImages = ['data:image/png;base64,<?= $l51_difficult_word_10_image ?>', 'data:image/png;base64,<?= $l51_difficult_word_10_image_2 ?>', 'data:image/png;base64,<?= $l51_difficult_word_10_image_3 ?>', 'data:image/png;base64,<?= $l51_difficult_word_10_image_4 ?>'];
               let currentAnswer = '';
               let correctAnswer = '<?= $l51_difficult_word_1_correct_word ?>'; // Set the initial correct answer
               ...
               function checkAnswer() {
                    ...
                    if (currentAnswer.toLowerCase() === correctAnswer) {
                         ...
                         setTimeout(() => {
                              if (correctAnswer === '<?= $l51_difficult_word_1_correct_word ?>') {
                                   loadDuckGame();
                                   correctAnswer = '<?= $l51_difficult_word_2_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_2_correct_word ?>') {
                                   loadPadGame();
                                   correctAnswer = '<?= $l51_difficult_word_3_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_3_correct_word ?>') {
                                   loadDotGame();
                                   correctAnswer = '<?= $l51_difficult_word_4_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_4_correct_word ?>') {
                                   loadBudGame();
                                   correctAnswer = '<?= $l51_difficult_word_5_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_5_correct_word ?>') {
                                   loadPotGame();
                                   correctAnswer = '<?= $l51_difficult_word_6_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_6_correct_word ?>') {
                                   loadRatGame();
                                   correctAnswer = '<?= $l51_difficult_word_7_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_7_correct_word ?>') {
                                   loadKitGame();
                                   correctAnswer = '<?= $l51_difficult_word_8_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_8_correct_word ?>') {
                                   loadTenGame();
                                   correctAnswer = '<?= $l51_difficult_word_9_correct_word ?>';
                              } else if (correctAnswer === '<?= $l51_difficult_word_9_correct_word ?>') {
                                   loadTopGame();
                                   correctAnswer = '<?= $l51_difficult_word_10_correct_word ?>';
                              }
